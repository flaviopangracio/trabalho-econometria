...
Se descrevermos o modelo como:

$$
log(H)_i = \beta_0 + \beta_1 S_i + \beta_2 E_i + \beta_3 R_i + \mu_i
$$

em que $log(H)_i =$ logaritmo da taxa de homicídio observada, $S_i =$ gasto per capita com segurança pública observada, $E_i =$ gastos per capita com educação observada, $R_i =$ renda média do setor formal observada e $\mu_i$ o resíduo observado.
